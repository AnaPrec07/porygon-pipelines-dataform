...
const tgt_monthly_sales_lead_1_months = `TGT monthly sales for observation.`;
const tgt_monthly_sales_lead_2_months = `TGT monthly sales for observation.`;
const tgt_monthly_sales_lead_3_months = `TGT monthly sales for observation.`;
const tgt_monthly_sales_lead_4_months = `TGT monthly sales for observation.`;
